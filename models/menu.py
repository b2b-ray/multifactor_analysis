...
if 'study' in request.vars:
    session['study'] = ObjectId(request.vars['study'])

response.menu = [
    (T('Home'), False, URL('default','index'), []),
    (T('setup'), False, URL(c='studies', f='manage', vars=dict(study=session.study))),
    (T('dataset'), False, URL(c='dataset', f='index', vars=dict(study=session.study))),
    (T('analyse'), False, URL(c='analyse', f='index', vars=dict(study=session.study)))
    ]
